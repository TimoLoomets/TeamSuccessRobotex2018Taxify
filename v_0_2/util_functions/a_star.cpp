...
//std::pair<double, double> a_star_start_loc
std::map<std::pair<double, double>, std::map<std::pair<double, double>, double> > * a_star_graph;
...
void a_star_calculate_path_to(std::pair<double, double> end_loc){
	if(closed_set.find(end_loc) == closed_set.end()){
		...
		while(!open_set.empty()){
			...
			for(auto neighbor : a_star_graph->find(current)->second){
...
std::vector<std::pair<double, double> > a_star_get_path_to(std::pair<double, double> end_loc){
	a_star_calculate_path_to(end_loc);
...
/*
void a_star_calculate_path(std::pair<double, double> start_loc, 
